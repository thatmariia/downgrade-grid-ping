...
class GaborLuminanceStimulusFactory:
    ...
    def _get_grating(self, spatial_freq: float, diameter_dg: float, diameter: int):
        """
    ...
    def _get_full_stimulus(
            ...
            grating, diameter: int, contrast_range: float, dist_scale: float,
            figure_start, figure_end
    ):
        """
    ...
    def _is_annulus_in_figure(
            self, annulus_corners, figure_start, figure_end
    ) -> bool:
        """
    ...
    def _select_stimulus_patch(
            self, stimulus, figure_center, patch_size: int
    ):
        """
