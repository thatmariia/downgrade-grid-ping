...
def plot_full_stimulus(stimulus):
    """
    Plots full stimulus.
...
def plot_stimulus_patch(stimulus_patch):
    """
...
def plot_local_contrasts(local_contrasts):
    """
...
def _plot_bw_square_heatmap(data, filename: str) -> None:
    """
